...
$sql = "SELECT tournament.tournament_name, sponsor.sponsor_name
FROM tournament
JOIN sponsor ON tournament.sponsor_id = sponsor.sponsor_id";
...
$count           = count($rows);
$unique_sponsors = $count > 0 ? count(array_unique(array_column($rows, 'sponsor_name'))) : 0;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Tournaments & Sponsors — Esports Tournament Management System</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  tbody tr:hover .t-icon { transform: scale(1.15); }
  ...
  tbody tr:hover .sponsor-badge {
    background: rgba(255,170,48,0.14);
    box-shadow: 0 0 14px rgba(255,170,48,0.25);
  }
  tbody tr:hover .sponsor-dot { opacity: 1; }
...
<div class="breadcrumb">
  ...
  <span class="breadcrumb-sep">›</span>
  <span class="breadcrumb-cur">Tournaments & Sponsors</span>
</div>
...
<main>
  ...
  <div class="page-top">
    <div class="pt-left">
      <!-- <div class="pt-eyebrow">Analytics — tournament JOIN sponsor</div> -->
      <h1><span>Tournaments and Their Sponsors</span></h1>
    </div>

    <?php if($count > 0): ?>
    <div class="sponsor-callout">
      <div class="callout-num"><?= $unique_sponsors ?></div>
      <div class="callout-label">Unique Sponsor<?= $unique_sponsors !== 1 ? 's' : '' ?></div>
      <div class="callout-sub">across <?= $count ?> tournament<?= $count !== 1 ? 's' : '' ?></div>
    </div>
    <?php endif; ?>
  </div>
  ...
  <div class="table-panel">
    <div class="table-scroll">
      <table>
        ...
        <tbody>
          <?php if($count === 0): ?>
            <tr class="empty-row"><td colspan="3">No sponsor data found</td></tr>
          <?php else: ?>
    ...
    <div class="table-foot">
      ...
      <div class="tf-query">Query: <span>tournament JOIN sponsor ON sponsor_id</span></div>
    </div>
  </div>
