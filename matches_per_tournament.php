...
$sql = "SELECT tournament.tournament_name, COUNT(match_table.match_id) AS total_matches
FROM match_table
JOIN tournament ON match_table.tournament_id = tournament.tournament_id
...
<title>Matches Per Tournament — Esports Tournament Management System</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .total-sub {
    ...
    color: rgba(255,68,102,0.4); margin-top: 4px;
  }
  ...
  td:last-child      { text-align: right; min-width: 220px; }
...
<div class="breadcrumb">
  ...
  <span class="breadcrumb-sep">›</span>
  <span class="breadcrumb-cur">Matches Per Tournament</span>
</div>
...
<main>
  ...
  <div class="page-top">
    <div class="pt-left">
      <!-- <div class="pt-eyebrow">Analytics — COUNT + GROUP BY + JOIN</div> -->
      <h1><span>Number of Matches per Tournament</span></h1>
    </div>

    <?php if($total_matches > 0): ?>
    <div class="total-callout">
      <div class="total-num"><?= $total_matches ?></div>
      <div class="total-label">Total Matches</div>
      <div class="total-sub">COUNT(match_id)</div>
    </div>
    <?php endif; ?>
  </div>
  ...
  <div class="table-panel">
            ...
            <tr>
              ...
              <td>
                <div class="match-cell">
                  ...
                  <span class="match-val"><?= $matches ?></span>
                  <span class="match-label">match<?= $matches !== 1 ? 'es' : '' ?></span>
                </div>
              </td>
            </tr>
            <?php endforeach; ?>
    ...
    <div class="table-foot">
      <div class="tf-label">
        ...
        <?= $count ?> tournament<?= $count !== 1 ? 's' : '' ?> found
      </div>
      <div class="tf-query">Query: <span>COUNT(match_id) GROUP BY tournament_name</span></div>
    </div>
  </div>
