...
<title>Add Player — Esports Tournament Management System</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .form-inner { padding: 40px 40px 44px; }
  ...
  .field:focus-within .label-dot {
    opacity: 1; box-shadow: 0 0 6px var(--cyan);
  }
  ...
  input[type="number"]::placeholder {
    color: var(--muted); opacity: 0.5; font-weight: 400;
  }
  ...
  select:focus {
    ...
    background: #080c14;
    box-shadow: 0 0 0 3px rgba(92,207,255,0.08), inset 0 0 20px rgba(92,207,255,0.03);
  }
  ...
  .field:focus-within .select-wrap::after { color: var(--cyan); }
  ...
  .select-wrap::before {
    ...
    box-shadow: 0 0 8px rgba(92,207,255,0.5);
  }
  .field:focus-within .input-wrap::after,
  .field:focus-within .select-wrap::before { transform: scaleX(1); }
  ...
  .note-dot { width: 4px; height: 4px; border-radius: 50%; background: var(--red); }
  ...
  button[type="submit"]:hover {
    background: #fff;
    box-shadow: 0 0 30px rgba(92,207,255,0.5);
...
<div class="breadcrumb">
  ...
  <span class="breadcrumb-sep">›</span>
  <span class="breadcrumb-cur">Add Player</span>
</div>
...
<main>
  <div class="form-container">
    ...
    <div class="page-top">
      <!-- <div class="pt-eyebrow">Players — INSERT Record</div> -->
      <h1><span>Add Player</span></h1>
    </div>
      ...
      <div class="form-inner">
        <form action="insert_player.php" method="POST">
          ...
          <div class="field-grid">
            ...
            <div class="field">
              <label><span class="label-dot"></span>Player Name</label>
              <div class="input-wrap">
                <input type="text" name="player_name" placeholder="Full name">
              </div>
            </div>

            <div class="field">
              <label><span class="label-dot"></span>Age</label>
              <div class="input-wrap">
            ...
            <div class="field">
              <label><span class="label-dot"></span>Role</label>
              <div class="input-wrap">
                <input type="text" name="role" placeholder="e.g. Duelist">
              </div>
            </div>

            <div class="field">
              <label><span class="label-dot"></span>Nationality</label>
              <div class="input-wrap">
            ...
            <div class="field full">
              <label><span class="label-dot"></span>Gamer Tag</label>
              <div class="input-wrap">
                <input type="text" name="gamer_tag" placeholder="e.g. xArcane">
              </div>
            </div>
            ...
            <div class="field full">
              <label><span class="label-dot"></span>Team</label>
              <div class="select-wrap">
                <select name="team_id">
                  <?php
                  $result = mysqli_query($conn, "SELECT team_id, team_name FROM team");
                  while ($row = mysqli_fetch_assoc($result)) {
                    echo "<option value='" . $row['team_id'] . "'>"
                       . $row['team_id'] . " — " . htmlspecialchars($row['team_name'])
                       . "</option>";
                  }
                  ?>
                </select>
          ...
          <div class="form-footer">
            <div class="form-note">
              ...
              All fields are optional except player name
            </div>
