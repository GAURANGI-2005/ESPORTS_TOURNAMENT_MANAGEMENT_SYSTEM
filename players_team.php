...
$sql = "SELECT player.player_name, player.age, team.team_name
FROM player
...
<title>Players With Their Teams — Esports Tournament Management System</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* join connector icon in header */
  .join-icon {
    display: inline-flex; align-items: center; gap: 6px;
    font-size: 11px;
  }
  .join-arrow {
    color: var(--purple); font-size: 14px; opacity: 0.6;
  }
...
<div class="breadcrumb">
  ...
  <span class="breadcrumb-sep">›</span>
  <span class="breadcrumb-cur">Players With Teams</span>
</div>
...
<main>
  ...
  <div class="page-top">
    <!-- <div class="pt-eyebrow">Players — INNER JOIN team</div> -->
    <h1><span>Players With Their Teams</span></h1>
  </div>
  ...
  <div class="table-panel">
      ...
      <table>
          ...
          <tr>
            ...
            <th>
              <span class="join-icon">
                Team <span class="join-arrow">⟵JOIN⟶</span>
              </span>
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          if (!$result || mysqli_num_rows($result) === 0) {
            echo "<tr class='empty-row'><td colspan='3'>No records found</td></tr>";
          } else {
            while ($row = mysqli_fetch_assoc($result)) {
              $count++;
              echo "<tr>
                <td class='td-name'>" . htmlspecialchars($row['player_name']) . "</td>
                <td><span class='age-badge'>" . htmlspecialchars($row['age']) . "</span></td>
                <td>
                  <span class='team-tag'>
    ...
    <div class="table-foot">
      ...
      <!-- <div class="tf-query">Query: <span>player JOIN team ON team_id</span></div> -->
    </div>
  </div>
